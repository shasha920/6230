...
lines(c(mean(data1$y[data1$x==1]),mean(data1$y[data1$x==2]),mean(data1$y[data1$x==3])),col = "red")
# From the lines, we can easily see that there is a nonliear relationship between X and Y
# however, if we use cor function to calculate the correlation between X and Y, we get
cor(data1$x,data1$y)
